...
<link href="{{asset('css/styles.css')}}" rel="stylesheet">
  ...
  <body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      ...
      <symbol id="infoCircle" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="{{route('admin.admin')}}">Admin panel</a>
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link @if(request()->routeIs('admin.categories.*')) active @endif" aria-current="page" href="{{route('admin.categories.index')}}">
              <svg class="bi me-2" width="16" height="16"><use xlink:href="#categories"/></svg>
