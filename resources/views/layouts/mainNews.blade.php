...
<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
  <div class="col-md-6 px-0">
    ...
    <p class="lead mb-0"><a href="{{ route('news.item', ['category'=>$topNews0['category_id'],'news'=>$topNews0['news_id']]) }}" class="text-white fw-bold">Read full article </a></p>
  </div>
</div>
  ...
  <div class="col">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
      <div class="col p-4 d-flex flex-column position-static">
        <strong class="d-inline-block mb-2 text-primary">{{$topNews1['category_name']}}</strong>
...
<div class="col">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
      <div class="col p-4 d-flex flex-column position-static">
        <strong class="d-inline-block mb-2 text-primary">{{$topNews2['category_name']}}</strong>
