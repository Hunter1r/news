@extends('layouts.main')
  ...
  @section('categories')
    @foreach($categories as $item)
      <a class="p-2 link-secondary" href="/news/{{$item}}">{{ $item }}</a>
    @endforeach
  @endsection
...
<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
  <div class="col-md-6 px-0">
    ...
    <p class="lead mb-0"><a href="{{ route('news.item', ['category'=>$topNews0['category'],'id'=>$topNews0['id']]) }}" class="text-white fw-bold">Read full article </a></p>
  </div>
</div>
  ...
  <div class="col">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
      <div class="col p-4 d-flex flex-column position-static">
        ...
        <a href="{{ route('news.item', ['category'=>$topNews1['category'], 'id'=>$topNews1['id']]) }}" class="stretched-link">Continue reading</a>
      </div>
...
<div class="col">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
      <div class="col p-4 d-flex flex-column position-static">
        ...
        <a href="{{ route('news.item', ['category'=>$topNews2['category'], 'id'=>$topNews2['id']]) }}" class="stretched-link">Continue reading</a>
      </div>
      <div class="col-auto d-none d-lg-block">
        <svg class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
      </div>
