...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="btn-toolbar mb-2 mb-md-0">
    <a class="btn btn-success" href="{{ route('admin.feedbacks.create') }}" role="button">Add</a>
</div>
</div>
  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <div class="navbar">
            <a href="{{route('admin.feedbacks.edit',['feedback'=>$item->id])}}">
...
document.addEventListener('DOMContentLoaded', (event) => {
            ...
            trashLinks.forEach(element => {
                element.addEventListener('click', (event) => {
                    modalTitle.textContent = "Deleting Feedback"
                    modalDescription.textContent = "Are you shure to delete Feedback with id=" + element
                        .dataset.id + " ?";
